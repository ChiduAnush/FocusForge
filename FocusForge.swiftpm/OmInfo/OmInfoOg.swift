...
//        "Moreover, the vibrations produced by chanting 'Aum' can have a healing effect on the body, promoting overall well-being and balance.\n\nCause of this, Aum is often chanted at the beginning and end of yoga sessions or meditation practices.",
...
//
//                    
//                    TextBubbleView(text: dialogues[currentDialogueIndex], characterName: "Guruji", isLastDialogue: $isLastDialogue, dismissAction: dismissAction) {
//
...
//                            }
//                            
////                            if dialogues[currentDialogueIndex] == "Great! lets now start chanting." {
////                                isLastDialogue = true
////                            }
//                            
//                        } else {
...
//                VideoPlayer(player: AVPlayer(url:  Bundle.main.url(forResource: "OmChidu2", withExtension: "mov")!)) {
//                    VStack {
...
//
////
////struct OmInfo1_Previews: PreviewProvider {
...
//                    displayedText.append(text[text.index(text.startIndex, offsetBy: counter)])
//                    counter += 1
//                } else {
